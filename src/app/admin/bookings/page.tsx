...
export default function AdminBookingsPage() {
  ...
  const exportCSV = () => {
    ...
    const headers = ['Booking ID', 'Date', 'Customer Name', 'Mobile', 'Email', 'City', 'Event', 'Tickets Count', 'Total Amount', 'Payment Status', 'Booking Status', 'Demo'];
    const csvContent = [
      headers.join(','),
              ...
              <tbody className="divide-y divide-gray-100">
                {filteredBookings.map((booking) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <div className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-gray-100 text-[#111111] font-[800] text-sm">
                        {booking.ticketCount}
                      </div>
                    </td>
