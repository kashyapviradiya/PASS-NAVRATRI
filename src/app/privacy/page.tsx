    ...
    <div className="bg-navratri-bg min-h-screen pb-32 font-sans">
      ...
      <section className="pt-24 pb-32 text-center relative overflow-hidden bg-navratri-dark">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-display-lg font-display text-white mb-4">Privacy Policy</h1>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 -mt-16 relative z-10">
        <div className="card-base p-8 md:p-12 border-none">
          <div className="space-y-10 text-navratri-muted font-medium leading-relaxed text-base">
            <section>
              <h2 className="text-2xl font-display font-bold text-navratri-text mb-4">1. Introduction</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-display font-bold text-navratri-text mb-4">2. The Data We Collect</h2>
            ...
            <section>
              <h2 className="text-2xl font-display font-bold text-navratri-text mb-4">3. How We Use Your Data</h2>
            ...
            <section>
              <h2 className="text-2xl font-display font-bold text-navratri-text mb-4">4. Data Security</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-display font-bold text-navratri-text mb-4">5. Contact Us</h2>
              <p>
