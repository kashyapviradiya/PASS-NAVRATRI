      ...
      <div className="w-full max-w-md relative z-10">
        <div className="bg-white/[0.03] backdrop-blur-xl rounded-[28px] shadow-glass border border-white/10 p-8 sm:p-12 relative overflow-hidden">
          ...
          <div className="text-center mb-8">
            <div className="w-24 h-24 bg-white/[0.06] rounded-[16px] flex items-center justify-center mx-auto mb-6 shadow-sm relative overflow-hidden border border-white/10">
