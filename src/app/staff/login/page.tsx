        ...
        <div className="bg-white rounded-[2.5rem] shadow-[0_20px_40px_-15px_rgba(90,0,0,0.1)] border border-gray-100 p-8 sm:p-12">
          ...
          <div className="text-center mb-8">
            <div className="w-20 h-20 bg-navratri-primary rounded-[1.5rem] flex items-center justify-center mx-auto mb-6 shadow-lg shadow-navratri-primary/30 relative overflow-hidden">
              ...
              <ScanFace className="w-10 h-10 text-navratri-gold relative z-10" />
            </div>
            <h1 className="text-3xl font-serif font-bold text-navratri-text mb-2">Staff Portal</h1>
            <p className="text-gray-500 font-light">Enter your secure credentials to access the ticket scanner</p>
          </div>
          ...
          <div className="mt-8 text-center text-xs text-gray-400 font-medium">
            <p>&copy; {new Date().getFullYear()} Pass Navratri Staff</p>
          </div>
        </div>
      </div>
    </div>
