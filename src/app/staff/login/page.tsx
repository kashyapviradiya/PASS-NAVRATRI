  ...
  return (
    <div className="min-h-screen bg-navratri-bg flex items-center justify-center p-4 font-sans relative overflow-hidden selection:bg-navratri-accent selection:text-white">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="bg-white rounded-card shadow-sm border border-navratri-lightGrey p-8 sm:p-12 relative overflow-hidden">
          
          <div className="text-center mb-8">
            <div className="w-20 h-20 bg-navratri-accent/10 rounded-[16px] flex items-center justify-center mx-auto mb-6 shadow-sm relative overflow-hidden border border-navratri-accent/10">
            ...
            <h1 className="text-[32px] font-display font-[700] text-navratri-text mb-2 tracking-tight">Staff Portal</h1>
            <p className="text-navratri-muted font-[500] text-[15px]">Enter your secure credentials to access the ticket scanner</p>
          </div>
            ...
            <div>
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full pl-12 pr-4 py-4 bg-navratri-bg border border-navratri-lightGrey rounded-[14px] focus:outline-none focus:ring-1 focus:ring-navratri-accent focus:border-navratri-accent font-[500] text-[15px] text-navratri-text transition-all placeholder:text-navratri-muted"
                  required
                />
              </div>
            </div>
