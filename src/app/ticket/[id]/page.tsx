    ...
    return (
      <div className="min-h-screen bg-[#F7F7F8] flex items-center justify-center">
        <div className="space-y-4 text-center">
          <div className="w-16 h-16 border-4 border-[#9333EA] border-t-transparent rounded-full animate-spin mx-auto"></div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="inline-flex items-center gap-3 bg-white px-5 py-2.5 rounded-2xl shadow-sm border border-gray-100 mt-4">
            ...
            <span className="text-[#9333EA] font-[800]">{params.id}</span>
            <button onClick={() => copyTicketId(params.id)} className="text-[#111111] hover:text-[#9333EA] transition-colors ml-2"><Copy className="w-4 h-4" /></button>
          </div>
        </motion.div>
            ...
            >
              ...
              <div className="bg-[#111111] p-8 text-white relative overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
                  <div>
                    <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#9333EA]/20 border border-[#9333EA]/30 text-[#9333EA] text-[10px] font-[800] tracking-widest uppercase mb-4">
              ...
              <div className="p-8 lg:p-10">
                  ...
                  <div className="md:col-span-3 space-y-6">
                    <div className="grid grid-cols-2 gap-6">
                      <div className="bg-gray-50 rounded-2xl p-4 border border-gray-100">
                        ...
                        <p className="font-[800] text-[#111111] text-sm flex items-center gap-2"><Calendar className="w-4 h-4 text-[#9333EA]" /> {ticket.eventDate}</p>
                      </div>
                      <div className="bg-gray-50 rounded-2xl p-4 border border-gray-100">
                        <p className="text-[10px] text-gray-400 uppercase tracking-widest font-[800] mb-1">Pass Type</p>
                        <p className="font-[800] text-[#9333EA] text-sm flex items-center gap-2"><TicketIcon className="w-4 h-4 text-[#9333EA]" /> {ticket.passType}</p>
                      </div>
                    </div>

                    <div className="bg-gray-50 rounded-2xl p-4 border border-gray-100">
                      <p className="text-[10px] text-gray-400 uppercase tracking-widest font-[800] mb-1">Guest Name</p>
                      <p className="font-[800] text-[#111111] text-lg flex items-center gap-2"><User className="w-4 h-4 text-[#9333EA]" /> {ticket.customerName}</p>
                    </div>

                    <div className="bg-gray-50 rounded-2xl p-4 border border-gray-100">
                      <p className="text-[10px] text-gray-400 uppercase tracking-widest font-[800] mb-1">Venue</p>
                      <p className="font-[800] text-[#111111] text-sm flex items-start gap-2"><MapPin className="w-4 h-4 text-[#9333EA] shrink-0 mt-0.5" /> {ticket.venue}</p>
                    </div>
                  </div>
                ...
                <div className="mt-8 p-5 bg-gray-50 rounded-2xl border border-gray-100 flex items-start gap-4">
                  <AlertCircle className="w-5 h-5 text-[#9333EA] shrink-0 mt-0.5" />
                  <div>
                    <p className="text-xs text-[#9333EA] font-[800] uppercase tracking-widest mb-2">Important Instructions</p>
